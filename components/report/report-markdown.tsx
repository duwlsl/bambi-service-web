...
/**
 * heading 역할.
 * - `section`: Delta 섹션 헤더(단일 주제의 `## 이번에 달라진 점`, 다주제의 `### 이번에 달라진 점`).
 ...
 *
 *   단일 주제  `## 이번에 달라진 점` / `### 달라진 사실`      → levels [2,3] → 섹션 2, 최심 3
 *   다주제     `## 주제명` / `### 이번에 달라진 점` / `#### 달라진 사실`
 ...
 * 둘 다 만족할 때만 changed/fresh 다. 문구가 다르면(`달라진 사실 안내`·`보고서 내용`·`주목할 점`·
