 ...
 */
const ERROR_COPY: Record<ReportType, { heading: string; subtext: string }> = {
  ON_DEMAND: { heading: "관심 자료 분석을 완료하지 못했어요", subtext: "잠시 후 다시 확인해 주세요." },
  MORNING_BRIEFING: {
    heading: "오늘의 아침 브리핑을 만들지 못했어요",
    subtext: "다음 브리핑에서 다시 준비할게요.",
  },
  ONBOARDING: { heading: "첫 리포트를 만들지 못했어요", subtext: "잠시 후 다시 확인해 주세요." },
};
 ...
 */
function ErrorSlot({ reportType }: { reportType: ReportType }) {
