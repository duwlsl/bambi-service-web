...
- **애플리케이션 코드는 팀 프로젝트 종료 시점 그대로**이며, 종료 후 변경한 것은 **포트폴리오용 README 문서화뿐**입니다.
- **개인 코드 개선은 아직 시작하지 않았습니다.** 진행하게 되면 [12. 프로젝트 종료 후 개인 개선 계획](#12-프로젝트-종료-후-개인-개선-계획)에 팀 프로젝트 당시 작업과 구분해 기록할 예정입니다.
...
| Vitest + Testing Library + MSW (jsdom) | 화면 렌더와 네트워크 계약 (상세 화면, 피드 오류·Empty, 모달 포커스, 중복 요청 회귀) | 8파일 **40 케이스 통과** |
...
애플리케이션 코드는 팀 프로젝트 종료 시점 그대로이며, **개인 코드 개선은 아직 시작하지 않았습니다.**
아래는 계획이며, 진행하면 작업 내용·날짜·근거 커밋을 팀 프로젝트 당시 작업과 구분해 이 절에 기록할 예정입니다.
