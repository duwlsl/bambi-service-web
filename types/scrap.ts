 ...
 * 스크랩 = 공개(PUBLIC) 카드 또는 **내 소유 카드**(PRIVATE 포함, service-api #85) 담기.
 * 내 관심 자료 저장(bookmarks)과 다른 개념(§CLAUDE.md).
 */

/** GET /api/scraps 목록 항목 — 담아둔 카드의 요약·태그·작성자(내 PRIVATE 카드도 포함된다). */
